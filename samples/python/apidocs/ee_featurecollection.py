...
display('FeatureCollection from a string:', collection_name_fc.limit(5).getInfo())
...
display('FeatureCollection from a single geometry:', single_geometry_fc.getInfo())
...
display('FeatureCollection from a single feature:', single_feature_fc.getInfo())
...
display('FeatureCollection from GeoJSON:', geojson_fc.getInfo())
