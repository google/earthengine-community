...
fc = ee.FeatureCollection('WRI/GPPD/power_plants').filter(
    'country_lg == "Belgium"')
display('N features in collection:', fc.size().getInfo())
...
display('N features in 30% sample:', random_sample_30.size().getInfo())

random_sample_70 = fc.filter('random >= 0.3')
display('N features in 70% sample:', random_sample_70.size().getInfo())
