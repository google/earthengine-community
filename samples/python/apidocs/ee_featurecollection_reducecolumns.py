...
display('Mean of a single property:', prop_mean.getInfo())
...
display('Mean of multiple properties:', props_mean.getInfo())
...
display('Weighted mean of a single property:', weighted_mean.getInfo())
