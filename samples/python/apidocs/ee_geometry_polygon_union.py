...
# [START earthengine__apidocs__ee_geometry_polygon_union]
...
m.add_ee_layer(polygon_union, {'color': 'red'}, 'Result [red]: polygon.union')
m
# [END earthengine__apidocs__ee_geometry_polygon_union]
