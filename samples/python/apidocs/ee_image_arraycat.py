...
display('1D array image (A) (pixel):', samp_arr_img(array_img_1d_a).getInfo())
# [0, 1, 2]
array_img_1d_b = ee.Image([3, 4, 5]).toArray()
display('1D array image (B) (pixel):', samp_arr_img(array_img_1d_b).getInfo())
# [3, 4, 5]
...
display('2D array image (A) (pixel):', samp_arr_img(array_img_2d_a).getInfo())
# [[0],
#  [1],
#  [2]]
array_img_2d_b = array_img_1d_b.toArray(1)
display('2D array image (B) (pixel):', samp_arr_img(array_img_2d_b).getInfo())
# [[3],
#  [4],
#  [5]]
