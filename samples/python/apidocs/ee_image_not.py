...
display('not_zeros:', not_zeros.sample(loc, 1).first().get('constant').getInfo())
display('zeros:', zeros.sample(loc, 1).first().get('constant').getInfo())
display('ones:', ones.sample(loc, 1).first().get('constant').getInfo())
