...
# [START earthengine__apidocs__ee_imagecollection_aggregate_array]
...
display('Mean of property values:',
        col.aggregate_mean(prop).getInfo())
display('Sum of property values:',
        col.aggregate_sum(prop).getInfo())
display('Product of property values:',
...
# [END earthengine__apidocs__ee_imagecollection_aggregate_array]
