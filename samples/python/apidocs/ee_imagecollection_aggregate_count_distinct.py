...
# [START earthengine__apidocs__ee_imagecollection_aggregate_count_distinct]
...
display('Summary stats of property values:')
...
# [END earthengine__apidocs__ee_imagecollection_aggregate_count_distinct]
