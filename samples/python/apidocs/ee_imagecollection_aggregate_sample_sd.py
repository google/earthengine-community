...
# [START earthengine__apidocs__ee_imagecollection_aggregate_sample_sd]
...
display('List of property values:', col.aggregate_array(prop).getInfo())
display('Count of property values:', col.aggregate_count(prop).getInfo())
display('Count of distinct property values:',
        col.aggregate_count_distinct(prop).getInfo())
display('First collection element property value:',
        col.aggregate_first(prop).getInfo())
display('Histogram of property values:')
pprint(col.aggregate_histogram(prop).getInfo())
display('Min of property values:', col.aggregate_min(prop).getInfo())
display('Max of property values:', col.aggregate_max(prop).getInfo())

# The following methods are applicable to numerical properties only.
display('Mean of property values:', col.aggregate_mean(prop).getInfo())
display('Sum of property values:', col.aggregate_sum(prop).getInfo())
display('Product of property values:', col.aggregate_product(prop).getInfo())
display('Std dev (sample) of property values:',
        col.aggregate_sample_sd(prop).getInfo())
display('Variance (sample) of property values:',
        col.aggregate_sample_var(prop).getInfo())
display('Std dev (total) of property values:',
        col.aggregate_total_sd(prop).getInfo())
display('Variance (total) of property values:',
        col.aggregate_total_var(prop).getInfo())
display('Summary stats of property values:', col.aggregate_stats(prop).getInfo())
...
display('List of property values (string):',
        col.aggregate_array(prop_string).getInfo())
display('Min of property values (string):',
        col.aggregate_min(prop_string).getInfo())
display('Max of property values (string):',
        col.aggregate_max(prop_string).getInfo())
# [END earthengine__apidocs__ee_imagecollection_aggregate_sample_sd]
