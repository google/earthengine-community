...
display('2020 images:', col.filterDate('2020', '2021').getInfo())
display('July images, 2020:', col.filterDate('2020-07', '2020-08').getInfo())
...
display('ee.DateRange input', col.filterDate(date_range).getInfo())
