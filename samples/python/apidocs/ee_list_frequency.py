...
display('List of integer:', ee_list.getInfo())
...
display('Frequency of value 0:', ee_list.frequency(0).getInfo())
display('Frequency of value 2:', ee_list.frequency(2).getInfo())
display('Frequency of value 9:', ee_list.frequency(9).getInfo())
