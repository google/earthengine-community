...
display('The second element:', ee_list.get(1).getInfo())
display('The fourth element:', ee_list.get(3).getInfo())
display('The last element:', ee_list.get(-1).getInfo())
display('The second to last element:', ee_list.get(-2).getInfo())

# ee.Number and integer computed objects are valid inputs.
display('Computed object index input:', ee_list.get(list.get(0)).getInfo())
