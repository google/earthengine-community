...
display('Original list:', ee_list.getInfo())
...
display('Remove 2nd from last element:', ee_list.splice(-2, 1).getInfo())

# Deletes 3 elements starting at position 1.
display('Remove multiple sequential elements:', ee_list.splice(1, 3).getInfo())
...
display('Insert new elements:', ee_list.splice(2, 0, ['X', 'Y', 'Z']).getInfo())
...
display('Replace elements:', ee_list.splice(2, 3, ['X', 'Y', 'Z']).getInfo())
