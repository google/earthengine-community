...
display('Hyperbolic cosine of -1:', ee.Number(-1).cosh().getInfo())  # 1.543080634
display('Hyperbolic cosine of 0:', ee.Number(0).cosh().getInfo())  # 1
display('Hyperbolic cosine of 1:', ee.Number(1).cosh().getInfo())  # 1.543080634
display('Hyperbolic cosine of 5:', ee.Number(5).cosh().getInfo())  # 74.209948524
