...
display('Number cast to int16:', int16_number.getInfo())
...
display('Floating point value cast to int16:', float_to_int16.getInfo())

# A number greater than int16 range max cast to int16 becomes int16 range max.
INT16_MAX = 32767
out_of_range_hi = ee.Number(INT16_MAX + 12345)
display('Greater than int16 max:', out_of_range_hi.getInfo())
...
display('Less than int16 min:', out_of_range_lo.getInfo())
