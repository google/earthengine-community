...
display('Number cast to int8:', int8_number.getInfo())
...
display('Floating point value cast to int8:', float_to_int8.getInfo())

# A number greater than int8 range max cast to int8 becomes int8 range max.
INT8_MAX = 127
out_of_range_hi = ee.Number(INT8_MAX + 12345)
display('Greater than int8 max:', out_of_range_hi.getInfo())
...
display('Less than int8 min:', out_of_range_lo.getInfo())
