...
display('Hyperbolic tangent of 0:', ee.Number(0).tanh().getInfo())  # 0
display('Hyperbolic tangent of 1:', ee.Number(1).tanh().getInfo())  # 0.761594155
display('Hyperbolic tangent of 5:', ee.Number(5).tanh().getInfo())  # 0.999909204
