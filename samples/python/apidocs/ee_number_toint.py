...
display('Number cast to int:', int_number.getInfo())
...
display('Floating point value cast to int:', float_to_int.getInfo())

# A number greater than int range max cast to int becomes int range max.
INT_MAX = 2147483647
out_of_range_hi = ee.Number(INT_MAX + 12345)
display('Greater than int max:', out_of_range_hi.getInfo())
...
display('Less than int min:', out_of_range_lo.getInfo())
