...
display('Floating point value cast to short:', float_to_short.getInfo())

# A number greater than short range max cast to short becomes short range max.
SHORT_MAX = 32767
out_of_range_hi = ee.Number(SHORT_MAX + 12345)
display('Greater than short max:', out_of_range_hi.getInfo())
...
display('Less than short min:', out_of_range_lo.getInfo())
...
# [END earthengine__apidocs__ee_number_toshort]
