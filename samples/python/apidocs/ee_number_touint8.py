...
display('Number:', number.getInfo())

uint8_number = number.toUint8()
display('Number cast to uint8:', uint8_number.getInfo())
...
display('Floating point value:', float_number.getInfo())

float_to_uint8 = float_number.toUint8()
display('Floating point value cast to uint8:', float_to_uint8.getInfo())

# A number greater than uint8 range max cast to uint8 becomes uint8 range max.
UINT8_MAX = 255
out_of_range_hi = ee.Number(UINT8_MAX + 12345)
display('Greater than uint8 max:', out_of_range_hi.getInfo())

out_of_range_hi_to_uint8 = out_of_range_hi.toUint8()
display('Greater than uint8 max cast to uint8 becomes uint8 max:',
...
display('Less than uint8 min:', out_of_range_lo.getInfo())

out_of_range_lo_to_uint8 = out_of_range_lo.toUint8()
display('Less than uint8 min cast to uint8 becomes uint8 min:',
