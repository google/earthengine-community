...
display('Number cast to uint32:', uint32_number.getInfo())
...
display('Floating point value cast to uint32:', float_to_uint32.getInfo())
...
display('Greater than uint32 max:', out_of_range_hi.getInfo())
...
display('Less than uint32 min:', out_of_range_lo.getInfo())
