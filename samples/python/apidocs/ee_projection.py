...
display(ee.Projection('EPSG:3857').getInfo())  # https://epsg.io/3857
display(ee.Projection('EPSG:4326').getInfo())  # https://epsg.io/4326
...
display(proj.getInfo())  # crs: EPSG:27572
