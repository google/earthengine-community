...
map_1.add_ee_layer(kelvin, {'min': 288, 'max': 305}, 'Kelvin')
map_1.add_ee_layer(hotspots, {'palette': 'FF0000'}, 'Hotspots')
...
map_1.add_ee_layer(object_id.randomVisualizer(), None, 'Objects')
...
map_1.add_ee_layer(object_size, None, 'Object n pixels')
...
map_1.add_ee_layer(object_area,
...
map_1.add_ee_layer(object_id, None, 'Large hotspots')
