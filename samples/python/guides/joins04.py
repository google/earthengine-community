...
mcd_43_a_4 = ee.ImageCollection('MODIS/MCD43A4_006_EVI').filter(date_filter)

# Load a MODIS collection with quality data.
mcd_43_a_2 = ee.ImageCollection('MODIS/006/MCD43A2').filter(date_filter)
...
# Apply the join.
inner_joined_modis = inner_join.apply(mcd_43_a_4, mcd_43_a_2, filter_time_eq)
