...
/**
 * Returns a copy of this dataset, copying all related state. Used internally
 * by builder methods to preserve immutability.
 *
 * @return {!Landsat8}
 */
Landsat8.prototype.clone_ = function() {
  return new Landsat8(this.collection_, this.defaultVisParams_);
};

/**
 * Masks clouds and shadows using relevant bits in the `pixel_qa` band
 * generated by the CFMASK algorithm.
 *
...
Landsat8.prototype.fmaskCloudsAndShadows = function() {
  var l8 = this.clone_();
  l8.collection_ = l8.collection_.map(Landsat8.applyCloudShadowBitMasks);
  return l8;
};
