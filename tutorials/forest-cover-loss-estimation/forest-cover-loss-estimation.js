...
Map.addLayer(
    canopyCover.selfMask(), {palette: ['#F3DE8A'], min: 1, max: 100},
...
Map.addLayer(
    canopyCover10, {palette: ['#EB7F00'], max: 100},
...
var featureCollection =
    ee.FeatureCollection([ee.Feature(null, {result: minAreaUsed})]);
...
Map.addLayer(
    treeLoss01, {palette: ['#000000']}, 'loss: all tree loss 2001 (black)',
    false);
...
Map.addLayer(
    treecoverLoss01, {palette: ['#9768D1']}, 'loss: inside tree cover (purple)',
    false);
...
Map.addLayer(
    minLoss.reproject(prj.atScale(scale)), {min: 0, palette: ['FF0000']},
...
Map.addLayer(
    selected.draw({color: '#000000', strokeWidth: 5}), {opacity: 0.3},
