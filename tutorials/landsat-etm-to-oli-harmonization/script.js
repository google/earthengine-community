...
// regression. Below are functions for all transformation options. Modify the above
// `prepOLI` and `prepETM` wrapper functions as needed to add/remove/replace
// transformation functions. Additionally, use the below `coefficients` dictionary
// instead of the one defined above (the following one includes all sets of
// coefficients).
